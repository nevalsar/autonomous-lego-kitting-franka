...
# cap.set(4, 100)
count=1
AZURE_KINECT_INTRINSICS = './azure_kinect.intr'
AZURE_KINECT_EXTRINSICS = './azure_kinect_overhead/azure_kinect_overhead_to_world.tf'
...
if __name__ == '__main__':
    ...
    print(object_center_point_in_world[0],object_center_point_in_world[1])
    input()
